...
public class CompraProveedorController {
    ...
    @PostMapping
    public ResponseEntity<CompraProveedor> guardarCompra(@RequestBody CompraProveedor compra) {
        try {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<CompraProveedor> obtenerCompraProveedorId(@PathVariable Long id) {
        try {
    ...
    @GetMapping
    public ResponseEntity<Page<CompraProveedor>> obtenerCompras(@RequestParam(defaultValue = "0") int pagina, @RequestParam(defaultValue = "10") int tamanio) {
        try {
    ...
    @DeleteMapping("/{id}")
    public ResponseEntity<Boolean> eliminarCompraProveedor(@PathVariable Long id) {
        try {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<CompraProveedor> actualizarCompraProveedor(@PathVariable Long id, @RequestBody CompraProveedor datosCambiar) {
        try {
