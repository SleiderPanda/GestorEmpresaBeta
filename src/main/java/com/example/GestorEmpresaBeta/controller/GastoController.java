...
public class GastoController {
    ...
    @PostMapping
    public ResponseEntity<Gasto> guardarGasto(Gasto gasto){
        try{
    ...
    @GetMapping("/{id}")
    public ResponseEntity<Gasto> obtenerGastoId(Long id){
        try{
    ...
    @GetMapping
    public ResponseEntity<Page<Gasto>> obtenerGastos(int pagina, int tamanio){
        try{
    ...
    @DeleteMapping("/{id}")
    public ResponseEntity<Boolean> eliminarGasto(Long id){
        try{
        ...
        @PutMapping("/{id}")
        public ResponseEntity<Gasto> actualizarGasto(Long id, Gasto datosCambiar){
            try{
