...
public class VentaController {
    ...
    @GetMapping
    public ResponseEntity<Page<Venta>> obtenerVentas(@RequestParam(defaultValue = "0") int pagina, @RequestParam(defaultValue = "10" )int tamanio){
        try {
    ...
    @DeleteMapping("/{id}")
    public ResponseEntity<Boolean> eliminarVenta(@PathVariable Long id){
        try {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<Venta> actualizarVenta(@PathVariable Long id, @RequestBody Venta datosCambiar){
        try {
